...
from relax.network.dpmd_v import DPMDNet_V, Diffv2Params
    ...
    def __init__(
        ...
        *,
        ...
        def stateless_update(
            ...
            next_eval_key, obs_aug_key, next_obs_aug_key, diffusion_time_key, diffusion_noise_key = jax.random.split(key, 5)
        ...
        self._implement_common_behavior(stateless_update, self.agent.get_action, self.agent.get_deterministic_action, stateless_get_action_full=self.agent.get_action_full,)
