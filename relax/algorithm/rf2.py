    ...
    def __init__(
        ...
        *,
        ...
        def stateless_update(
            ...
            next_action, next_action0 = self.agent.get_action_coupled(next_eval_key, (policy_params, log_alpha, q1_params, q2_params), next_obs)
            next_action0 += 0.2 * jax.random.normal(new_eval_key, next_action.shape)
            ...
            def policy_loss_fn(policy_params) -> jax.Array:
                ...
                loss = self.agent.flow.weighted_p_loss_coupled(next_action0, q_weights, denoiser, t,
